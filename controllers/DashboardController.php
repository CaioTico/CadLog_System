...
<body class="<?php echo $_SESSION['perfil']; ?>"> <!-- Define a classe com base no perfil -->
    <div class="container">
        <h1>Bem-vindo, Usuário <?php echo $_SESSION['perfil']; ?>!</h1>
        <p>Esta é a visão do perfil: <?php echo $_SESSION['perfil'];?>.</p>
